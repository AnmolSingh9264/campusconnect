      ...
      <section className="hidden md:flex md:w-5/12 primary-gradient relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white text-2xl font-headline font-extrabold tracking-tight">Hire Skills</span>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-white/90 text-lg leading-relaxed font-medium">
            Our AI-driven platform bridges the gap between skill and opportunity. 
            Join the elite network of developers and visionaries today.
          </p>
          ...
          <div className="mt-12 space-y-6">
            ...
            >
              ...
              <div>
                <p className="text-white font-semibold text-sm">"Found my dream CTO role in 2 weeks."</p>
                <p className="text-white/60 text-xs">— Sarah Jenkins, Tech Lead</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="w-full max-w-[500px]">
          ...
          <div className="mb-12">
            <div className="flex justify-between items-center mb-4">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-primary">Step 1 of 3</span>
              <a className="text-sm font-medium text-brand-outline hover:text-brand-primary transition-colors flex items-center gap-1" href="#">
                Already have an account? <span className="text-brand-primary font-bold" onClick={() => navigate('/login', {replace:true})}>Sign In</span> 
              </a>
            </div>
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-headline font-extrabold text-brand-on-surface mb-3">Choose your path</h2>
            <p className="text-brand-on-surface-variant font-medium leading-relaxed">
              To get started, please tell us how you plan to use Hire Skills. You can always change this later.
            </p>
          </div>
          ...
          <div className="space-y-4 mb-10">
            ...
            >
              <div className={`w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors ${
                selectedRole === 'candidate' ? 'bg-brand-primary-light text-white' : 'bg-brand-surface text-brand-primary group-hover:bg-brand-primary/10'
              }`}>
                <Brain className="w-8 h-8" />
              </div>
              <div className="flex-1">
                <h3 className="text-lg font-bold text-brand-on-surface mb-1">I'm a Candidate</h3>
                <p className="text-sm text-brand-on-surface-variant leading-snug">
                  Showcase your skills, take challenges, and get hired by world-class companies.
                </p>
              </div>
              <div className={`absolute top-4 right-4 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                selectedRole === 'candidate' ? 'border-brand-primary bg-brand-primary' : 'border-brand-outline-variant group-hover:border-brand-primary'
              }`}>
                {selectedRole === 'candidate' && (
                  <motion.div layoutId="selectionCircle" className="w-2 h-2 rounded-full bg-white" />
                )}
              </div>
            </motion.button>
            ...
            >
              <div className={`w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors ${
                selectedRole === 'recruiter' ? 'bg-brand-primary-light text-white' : 'bg-brand-surface text-brand-primary group-hover:bg-brand-primary/10'
              }`}>
                <Search className="w-8 h-8" />
              </div>
              <div className="flex-1">
                <h3 className="text-lg font-bold text-brand-on-surface mb-1">I'm a Recruiter</h3>
                <p className="text-sm text-brand-on-surface-variant leading-snug">
                  Find pre-vetted technical talent, launch challenges, and streamline your hiring flow.
                </p>
              </div>
              <div className={`absolute top-4 right-4 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                selectedRole === 'recruiter' ? 'border-brand-primary bg-brand-primary' : 'border-brand-outline-variant group-hover:border-brand-primary'
              }`}>
                {selectedRole === 'recruiter' && (
                  <motion.div layoutId="selectionCircle" className="w-2 h-2 rounded-full bg-white" />
                )}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 my-2">
              ...
              <span className="text-xs font-bold text-brand-outline uppercase tracking-widest whitespace-nowrap">Or social sign up</span>
              <div className="flex-1 h-px bg-brand-outline-variant" />
            </div>
          ...
          <div className="mt-8 text-center md:text-left">
            <button onClick={()=>navigate(-1)} className="text-sm font-bold text-brand-outline hover:text-brand-primary transition-colors inline-flex items-center gap-1 group">
